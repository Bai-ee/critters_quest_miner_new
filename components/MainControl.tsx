...
export function MainControl({ round, miner, selectedSquares, selectAll, clearSelection, randomSelection, solBalance, automation, interfaceLocked = false }: MainControlProps) {
    ...
    const handleDeploy = async () => {
        ...
        // Use bigIntToNumber for proper comparison
                        ...
                        <>
                            ...
                            <div className="flex flex-col gap-3">
                                <button
                                    ...
                                    disabled={interfaceLocked || !publicKey || deploying || selectedSquares.size === 0 || solBalance < (amount * selectedSquares.size + 0.01)}
                        ...
                        <>
                            ...
                            {automation ? (
                                <button
                                    ...
                                    disabled={interfaceLocked || loading}
                                ...
                                <button
                                    ...
                                    disabled={interfaceLocked || !publicKey || loading || selectedSquares.size === 0 || solBalance < totalCost}
